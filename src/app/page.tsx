  ...
  return (
    <main className="flex space-y-4 min-h-screen flex-col items-center justify-center p-8">
      ...
      <div className="flex flex-row items-center gap-8">
        <Link href="https://github.com/KDercksen/url_shortener">
          <svg
            role="img"
            className="size-8 hover:text-gray-700"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <Dialog>
          <DialogTrigger>
            <div className="flex flex-row items-center p-2 rounded-lg hover:ring hover:ring-primary">
              <WrenchIcon className="size-4 mr-2" /> API
            </div>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
              <DialogTitle>How to use the API</DialogTitle>
              <DialogDescription>
